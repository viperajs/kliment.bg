        ...
        <div className="min-h-screen bg-background">
            ...
            <div className="container mx-auto px-4 md:px-6 py-8 md:py-12">
                <Tabs defaultValue="1-klas" className="w-full">
                    <TabsList className="grid w-full grid-cols-2 md:grid-cols-4 bg-card p-1 rounded-2xl mb-8 md:mb-12 h-auto">
                        <TabsTrigger value="1-klas" className="rounded-xl py-2 md:py-3 text-xs md:text-sm data-[state=active]:bg-blue-500 data-[state=active]:text-white">1-ви Клас</TabsTrigger>
                        <TabsTrigger value="5-klas" className="rounded-xl py-2 md:py-3 text-xs md:text-sm data-[state=active]:bg-indigo-500 data-[state=active]:text-white">5-ти Клас</TabsTrigger>
                        <TabsTrigger value="8-klas" className="rounded-xl py-2 md:py-3 text-xs md:text-sm data-[state=active]:bg-purple-500 data-[state=active]:text-white">8-ми Клас</TabsTrigger>
                        <TabsTrigger value="11-klas" className="rounded-xl py-2 md:py-3 text-xs md:text-sm data-[state=active]:bg-emerald-500 data-[state=active]:text-white">11-ти Клас</TabsTrigger>
                    </TabsList>
                    ...
                    <TabsContent value="1-klas" className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="grid md:grid-cols-2 gap-4 md:gap-8">
                            <div className="space-y-6">
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-foreground">Прием в Първи Клас</h2>
                                ...
                                <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-6">
                                    <h4 className="font-bold text-blue-600 dark:text-blue-400 mb-2 flex items-center"><Calendar className="w-4 h-4 mr-2" /> Важни Срокове</h4>
                            ...
                            <div className="bg-card rounded-2xl p-5 md:p-8 border border-border">
                                <h3 className="text-xl font-bold text-foreground mb-6 flex items-center"><FileText className="mr-2 text-secondary" /> Необходими документи</h3>
                                ...
                                <Button className="w-full mt-8 bg-blue-600 hover:bg-blue-700 text-white">Изтегли Заявление</Button>
                            </div>
                        </div>
                    </TabsContent>
                    ...
                    <TabsContent value="5-klas" className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="grid md:grid-cols-2 gap-4 md:gap-8">
                            <div className="space-y-6">
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-foreground">Прием в Пети Клас</h2>
                                <p className="text-muted-foreground leading-relaxed">
                                ...
                                <div className="bg-indigo-500/10 border border-indigo-500/20 rounded-xl p-6">
                                    <h4 className="font-bold text-indigo-600 dark:text-indigo-400 mb-2 flex items-center"><Info className="w-4 h-4 mr-2" /> Критерии за прием</h4>
                            ...
                            <div className="bg-card rounded-2xl p-5 md:p-8 border border-border">
                                ...
                                <Button className="w-full mt-8 bg-indigo-600 hover:bg-indigo-700 text-white">Изтегли Заявление</Button>
                            </div>
                        </div>
                    </TabsContent>
                    ...
                    <TabsContent value="8-klas" className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="grid md:grid-cols-2 gap-4 md:gap-8">
                            <div className="space-y-6">
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-foreground">Прием в Осми Клас</h2>
                                <p className="text-muted-foreground leading-relaxed">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div className="bg-card p-4 rounded-xl border border-border hover:border-purple-500/50 transition-colors">
                                        <h4 className="font-bold text-foreground mb-2">Профилиращи предмети</h4>
                                    ...
                                    <div className="bg-card p-4 rounded-xl border border-border hover:border-purple-500/50 transition-colors">
                                        <h4 className="font-bold text-foreground mb-2">Балообразуване</h4>
                                        <ul className="text-sm text-muted-foreground list-disc list-inside">
                                            <li>2 x НВО БЕЛ</li>
                            ...
                            <div className="bg-card rounded-2xl p-5 md:p-8 border border-border">
                                <h3 className="text-xl font-bold text-foreground mb-6 flex items-center"><FileText className="mr-2 text-secondary" /> Кандидатстване</h3>
                    ...
                    <TabsContent value="11-klas" className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="max-w-3xl">
                            <h2 className="text-2xl md:text-3xl font-serif font-bold text-foreground mb-4 md:mb-6">Прием в Единадесети Клас</h2>
                            <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-5 md:p-8">
                                ...
                                <Button variant="outline" className="border-emerald-500/50 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-500/10" asChild>
