...
>(({ className, ...props }, ref) => (
    <TabsPrimitive.List
        ref={ref}
        className={cn(
            "inline-flex h-12 w-full items-center justify-start rounded-xl bg-white/5 p-1 text-slate-400",
            className
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <TabsPrimitive.Trigger
        ...
        className={cn(
            ...
            "data-[state=active]:bg-secondary data-[state=active]:text-slate-900 data-[state=active]:shadow-md hover:text-white hover:bg-white/5",
            className
        )}
        {...props}
    />
